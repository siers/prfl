...
export default class ToneLibX {
  ...
  addAccidental({semi, name, alter}: Note, accidental) {
  ...
  rebase({semi, name, alter, render}, baseSemi): Note {
  ...
  modulateFifthBaseless(key, direction) {
    switch (direction) {
      case 1: return arrayShift(this.keyAddAccidental(key, this.fourth, this.sharp), this.fifth)
      case -1: return arrayShift(this.keyAddAccidental(key, this.seventh, this.flat), this.fourth)
      case 0: return key
      default:
